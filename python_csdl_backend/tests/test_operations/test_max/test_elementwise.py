...
class ElementWiseMaxSample(csdl.Model):
...
def test_elementwisemax():
    ...
    run_test(
        ElementWiseMaxSample(scalability_param=1),
        outs=['y'],
        ins=['x', 'w'],
        name='test_elementwisemax',
        vals_dict=vals_dict,
